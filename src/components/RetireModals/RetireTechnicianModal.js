...
export default function RetireTechnicianModal({openStatus, handleCloseModal, retireTechnician}) {
    ...
    <div>
      ...
      >
        <Box sx={{...style, textAlign:'center',borderRadius: 2 }}>
          ...
          <Button onClick ={retireTechnician} size="large" variant="contained" color="success">Submit</Button>            
