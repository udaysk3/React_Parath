...
export default function RetireModal({clientId, openStatus, retireDevice, handleCloseModal, rowSelectionModel}) {
    ...
    <div>
      ...
      >
        <Box sx={{...style, textAlign:'center',borderRadius: 2 }}>
          ...
          <Button onClick ={retireDevice} size="large" variant="contained" color="success">Submit</Button>
